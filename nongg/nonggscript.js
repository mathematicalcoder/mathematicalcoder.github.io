...
function upA() {
  if (pts > 1e+5) {
    document.getElementById("boost3").innerHTML = "<button type=\"button\" class=\"btn btn-primary\" onclick=\"addptsC();\">Booster 3</button>"
...
function upB() {
  if (pts > 1e+8) {
    ...
    document.getElementById("u03place").innerHTML = '<button type="button" class="btn btn-secondary" id="u3button" onclick="upC();">U03: Multiply point gain by 500</button> <span id="u03">(prerequisite: have 1e+11 points)</span>'
